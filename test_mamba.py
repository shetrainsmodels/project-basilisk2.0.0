...
def test_model(model, test_loader, device, class_names = None):
    ...
    f1 = f1_score(all_labels, all_preds, labels = labels, average = "macro", zero_division = 0) # macro over the FIXED label set (same denominator on every fold, even if the test subject lacks classes)
